...
export const DashBoardAside = (props: DashBoardAsideProps) => {
    ...
    return (
        <div className={`${props?.className ?? ''} min-h-[100vh]  hidden md:block`}>
            <div
                className={`hidden md:block bg-bg h-[100vh] overflow-x-hidden overflow-y-auto scrollbar fixed top-0 left-0 shadow-1  ${
                    isOpenDesktop
        ...
        <div
            ...
            <div className={`relative w-full h-full `}>
                ...
                <div
                    ...
                    className={`absolute top-0 left-0 w-full h-full bg-[rgb(var(--bg-opposite),0.8)] z-[20] transition-all duration-300 cursor-pointer ${isOpenMobile ? 'opacity-100' : 'opacity-0'}`}></div>
            </div>
        </div>
    )
}
        ...
        >
          {props?.iconName ? props.iconName : 'question_mark'}
            {props.isNotify && (
                ...
                <span
                    className={`flex-1 text-[13px] leading-[1.1]  ${
